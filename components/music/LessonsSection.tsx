...
const musicBodyCopy = 'text-base leading-relaxed md:leading-7';
    ...
    <section id="lessons" className="relative z-10 pt-10">
      ...
      <div className="max-w-2xl mx-auto md:mx-0">
        <p className={`${musicBodyCopy} mb-6 text-[#e8d4c4]`}>
          I&rsquo;ve been playing for 30+ years and teaching for most of them. My approach is
          simple — we learn through music you actually want to play. No dry exercises,
          no one-size-fits-all method. Just real songs, real technique, real progress.
        </p>

        <p className={`${musicBodyCopy} mb-10 text-[#e8d4c4]`}>
          <span className="font-semibold text-[#fff8f0]">My approach:</span> Theory when it
          serves the music, technique when it unlocks the next level, and always — always —
        ...
        <p className={`${musicBodyCopy}`} style={{ color: music.accent }}>
          Somewhere between the next riff and the first commit…
        </p>
      </div>
    </section>
  );
