    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          ...
          />
          <FloatingInput
            id="phone" label="Phone (optional)" type="tel" value={values.phone}
        ...
        <FloatingTextarea
          id="message" label="Message" value={values.message}
        ...
        {status === 'error' && (
          <p className="text-center text-xs text-[#ff4f4f]" style={{ fontFamily: FONT_DEV }}>
            Something went wrong. <button className="underline" onClick={() => setStatus('idle')}>Reset</button>
          </p>
        )}
      </div>
    </div>
