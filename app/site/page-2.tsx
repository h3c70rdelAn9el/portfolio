...
const content = {
  ...
  music: {
    ...
    bio: "Some people journal. I play guitar. Same thing, different strings. Right now you caught me on the music side — pull up a chair.",
    ...
    >
      ...
      <section className="relative z-10 flex flex-col justify-center min-h-[calc(100vh-88px)] px-8 md:px-16 pb-20">
        ...
        >
          Hey, I&apos;m
          <br />
          <em className="not-italic" style={{ color: c.accent, transition: "color 0.5s" }}>
            Hector
          </em>{" "}
          del Angel.
        </h1>
